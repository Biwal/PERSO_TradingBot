...
from BtcTradingGraph import BtcTradingGraph

MAX_TRADING_SESSION = 100000  # ~2 months


class TradingBotGymEnv(gym.Env):
    ...
    def __init__(
        self,
        df,
        # indicate how many time steps in the past the agent will observe at each step
        lookback_window_size=50,
        commission=0.00075,
        initial_balance=10000,
        # meaning our data frame will be traversed in random slices by default
        serial=False,
    ):
        super(TradingBotGymEnv, self).__init__()
